        ...
        <Container>
          ...
          <Navbar.Collapse id="navbar-nav">
            <Nav className="me-auto">
              ...
              <Nav.Link onClick={() => handleCategoryClick("history")} className="text-light">
                History
              </Nav.Link>

              <Nav.Link onClick={() => handleCategoryClick("favorite")} className="text-light">
                Favorite
              </Nav.Link>
      ...
      <Row>
        <Col xs={12} md={3}>
          ...
          <Nav className="flex-column">
            ...
            <Nav.Link onClick={() => handleCategoryClick("")}>
              Entertainment
            </Nav.Link>
          </Nav>
        </Col>
